...
#pragma region LoadAimbot
	...
	g_Options.AIMBOT.aimatknocked = CSX::Cvar::LoadCvar(AIMBOT_TEXT, A_autoknocked, g_Options.AIMBOT.aimatknocked) != false;
...
#pragma region LoadESP
	...
	g_Options.ESP.ESP_ENEMY.enemyid = CSX::Cvar::LoadCvar(ESP_TEXT, E_enemyid, g_Options.ESP.ESP_ENEMY.enemyid) != false;
	...
	g_Options.ESP.ESP_TEAM.teamid = CSX::Cvar::LoadCvar(ESP_TEXT, E_teamid, g_Options.ESP.ESP_TEAM.teamid) != false;
...
#pragma region LoadCOLORS
	...
	string teamknocked = CSX::Cvar::LoadCvar(COLORS_TEXT, C_teamknocked, "0,0,0");
	string visknocked = CSX::Cvar::LoadCvar(COLORS_TEXT, C_visknocked, "0,0,0");
	string unvisknocked = CSX::Cvar::LoadCvar(COLORS_TEXT, C_unvisknocked, "0,0,0");
	...
	ScanColorFromCvar(teamknocked.c_str(), g_Options.COLOR.Teamknocked);
	ScanColorFromCvar(visknocked.c_str(), g_Options.COLOR.Visknocked);
	ScanColorFromCvar(unvisknocked.c_str(), g_Options.COLOR.UnVisknocked);
	...
	for (DWORD i = 0; i < TEAM_DATA_SIZE; i++)
	{
		string TeamColorid = CSX::Cvar::LoadCvar(COLORS_TEXT, pTeamData[i], "0,0,0");
		ScanColorFromCvar(TeamColorid.c_str(), g_Options.COLOR.id[i].Team);
...
#pragma region SaveAimbot
	...
	CSX::Cvar::SaveCvar(AIMBOT_TEXT, A_autoknocked, g_Options.AIMBOT.aimatknocked);
...
#pragma region SaveESP
	...
	CSX::Cvar::SaveCvar(ESP_TEXT, E_teamid, g_Options.ESP.ESP_TEAM.teamid);
	CSX::Cvar::SaveCvar(ESP_TEXT, E_enemyid, g_Options.ESP.ESP_ENEMY.enemyid);
...
#pragma region SaveCOLOR
	...
	string TeamKnocked =
		to_string(int(g_Options.COLOR.Teamknocked[0] * 255.f)) + "," +
		to_string(int(g_Options.COLOR.Teamknocked[1] * 255.f)) + "," +
		to_string(int(g_Options.COLOR.Teamknocked[2] * 255.f));
	string VisKnocked =
		to_string(int(g_Options.COLOR.Visknocked[0] * 255.f)) + "," +
		to_string(int(g_Options.COLOR.Visknocked[1] * 255.f)) + "," +
		to_string(int(g_Options.COLOR.Visknocked[2] * 255.f));
	string UnVisKnocked =
		to_string(int(g_Options.COLOR.UnVisknocked[0] * 255.f)) + "," +
		to_string(int(g_Options.COLOR.UnVisknocked[1] * 255.f)) + "," +
		to_string(int(g_Options.COLOR.UnVisknocked[2] * 255.f));
	...
	CSX::Cvar::SaveCvar(COLORS_TEXT, C_teamknocked, TeamKnocked);
	CSX::Cvar::SaveCvar(COLORS_TEXT, C_visknocked, VisKnocked);
	CSX::Cvar::SaveCvar(COLORS_TEXT, C_unvisknocked, UnVisKnocked);
	...
	{
		string Teamid =
			to_string(int(g_Options.COLOR.id[i].Team[0] * 255.f)) + "," +
			to_string(int(g_Options.COLOR.id[i].Team[1] * 255.f)) + "," +
			to_string(int(g_Options.COLOR.id[i].Team[2] * 255.f));
			CSX::Cvar::SaveCvar(COLORS_TEXT, pTeamData[i], Teamid);
	}
#pragma endregion
