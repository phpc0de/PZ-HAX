...
struct Variables
{
	...
	struct 
	{
		...
		float Teamknocked[3] = { 0.f, 0.2f, 1.f };
		float Visknocked[3] = { 0.f, 0.2f, 1.f };
		float UnVisknocked[3] = { 0.f, 0.2f, 1.f };
		...
		struct ID
		{
			float Team[3] = { 0.f, 0.2f, 1.f };
			float Vehicle[3] = { 0.f, 0.2f, 1.f };
