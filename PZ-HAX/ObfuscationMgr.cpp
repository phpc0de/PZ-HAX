...
fb::ClientPlayer* ObfuscationMgr::GetLocalPlayer()
{
	...
	return (fb::ClientPlayer*)LocalPlayer;

}

std::vector<fb::ClientPlayer*>* ObfuscationMgr::GetPlayers()
{
	PlayerList.clear();
...
std::vector<fb::ClientPlayer*>* ObfuscationMgr::GetSpectators()
{
	SpectatorList.clear();
...
fb::ClientPlayer* ObfuscationMgr::GetPlayerById(DWORD id)
{
	DWORD64 ClientPlayerManager = 0x0;
	DWORD64 LocalPlayerListXorValue1 = 0x0;
	DWORD64 LocalPlayerListXorValue2 = 0x0;
	...
	return (fb::ClientPlayer*)ClientPlayer;
}

fb::ClientPlayer* ObfuscationMgr::GetSpectatorById(DWORD id)
{
	DWORD64 ClientPlayerManager = 0x0;
	DWORD64 LocalPlayerListXorValue1 = 0x0;
	DWORD64 LocalPlayerListXorValue2 = 0x0;
	...
	return (fb::ClientPlayer*)SpectatorPlayer;
}
